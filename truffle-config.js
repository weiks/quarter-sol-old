...
//
// const fs = require('fs');
 const mnemonic = "virus inmate exchange ancient despair dog lens pill fossil caught rude text";
...
module.exports = {
  ...
  networks: {
   ...
   // Useful for deploying to a public network.
    ...
    kovan: {
    provider: () => new HDWalletProvider(mnemonic, `https://polygon-mumbai.infura.io/v3/7cd4731a3be74a6ab7c32fe799ab3177`),
    network_id: 80001,
    confirmations: 3,
    networkCheckTimeout: 100000000,       // Ropsten's id
